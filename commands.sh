...
CUDA_VISIBLE_DEVICES=4 DDEBACKEND=tensorflow python experiments/beltrami_flow/Beltrami_flow.py
CUDA_VISIBLE_DEVICES=5 DDEBACKEND=tensorflow python experiments/beltrami_flow/Beltrami_flow.py --resample
